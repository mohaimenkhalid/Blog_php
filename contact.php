...
if ( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	elseif(empty($email)){
		$error = "Email name must not empty.";
	}
	...
	elseif(empty($body)){
		$error = "message field must not empty.";
	}

	else{

		$postquery = "INSERT INTO tbl_contact( firstname, lastname, email, body) VALUES('$fname', '$lname', '$email', '$body' )";
